configObj = {
  ...
  buttonDToRight: "40px",
  selectedBackgroundColor: "#9d2e51",
  selectedIconColor: "#03182b",
  buttonWidth: "56px",
  buttonHeight: "56px",
  svgWidth: "48px",
  svgHeight: "48px",
...
window.addEventListener("load", function () {
  loader.classList.add("loading-container-hidden");
  ...
  setTimeout(() => {
    loader.remove();
    body.classList.add("overflow");
    document.getElementById("load-anim").classList.add("load");
    document.getElementById("load-opacity-anim").classList.add("load-opacity");
  }, 1250);
});
